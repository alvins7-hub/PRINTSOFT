...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Ubah Data Produk
    </div>
    <!-- form ubah data -->
        ...
        <div class="row">
            <div class="col-xl-6">
                ...
                <div class="mb-3 pe-xl-3">
                    ...
                    <input type="text" name="nama" class="form-control" autocomplete="off" value="<?php echo $data['name']; ?>" required>
                    <div class="invalid-feedback">Nama tidak boleh kosong.</div>
                </div>

                <div class="mb-3 pe-xl-3">
                    <label class="form-label">Harga <span class="text-danger">*</span></label>
                    <input type="text" name="harga" class="form-control" autocomplete="off" value="<?php echo $data['price']; ?>" required>
                    <div class="invalid-feedback">Harga tidak boleh kosong.</div>
                </div>

                <div class="mb-3 pe-xl-3">
                    <label class="form-label">Stock <span class="text-danger">*</span></label>
                    <input type="text" name="stock" class="form-control" autocomplete="off" value="<?php echo $data['stock']; ?>" required>
                    <div class="invalid-feedback">Stock tidak boleh kosong.</div>
                </div>
                ...
                <div class="mb-4 pe-xl-3">
                    ...
                    if ($data['formula'] == 'unit') { ?>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="unit" name="formula" class="form-check-input" value="unit" checked required>
                            <label class="form-check-label" for="unit">Unit</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="area" name="formula" class="form-check-input" value="area" required>
                            <label class="form-check-label" for="area">Area</label>
                            <div class="invalid-feedback invalid-feedback-inline">Pilih salah satu formula.</div>
                        </div>
                    <?php
                    } else { ?>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="unit" name="formula" class="form-check-input" value="unit" required>
                            <label class="form-check-label" for="unit">Unit</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="area" name="formula" class="form-check-input" value="area" checked required>
                            <label class="form-check-label" for="area">Area</label>
                            <div class="invalid-feedback invalid-feedback-inline">Pilih salah satu formula.</div>
                        </div>
                    <?php } ?>
