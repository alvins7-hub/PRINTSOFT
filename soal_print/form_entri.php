...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Entri Data Produk
    </div>
    <!-- form entri data -->
            ...
            <div class="col-xl-6">
                <div class="row g-0">
                    <div class="mb-3 col-xl-6 pe-xl-3">
                        <?php
                        // membuat "id"
                        // sql statement untuk menampilkan 5 digit terakhir dari "id" pada tabel "produk"
                        $query = $mysqli->query("SELECT RIGHT(id,5) as nomor FROM produk ORDER BY id DESC LIMIT 1")
                        ...
                        $id = $nomor_urut;//"ID-" . str_pad($nomor_urut, 5, "0", STR_PAD_LEFT);
                        ?>
