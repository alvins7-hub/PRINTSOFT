...
<div class="row">
    ...
    ?>
        ...
        <?php
        // sql statement untuk menampilkan data dari tabel "produk" berdasarkan "kata_kunci"
        $query = $mysqli->query("SELECT id, name, price, stock FROM produk 
                                 WHERE id LIKE '%$kata_kunci%' OR name LIKE '%$kata_kunci%'
                                 ORDER BY id ASC")
                ...
                <div class="p-2">
                    <div class="d-flex bg-white rounded-4 shadow-sm">
                        ...
                        <div class="p-4 flex-grow-1">
                            <h5><?php echo $data['id']; ?> - <?php echo $data['price']; ?></h5>
        ...
        // jika data Produk tidak ada
            ...
            <div class="col-12">
                ...
                Data Produk dengan kata kunci <span class="text-primary fst-italic px-2">"<?php echo $kata_kunci; ?>"</span> tidak ditemukan.
            </div>
    <?php
        }
    }
